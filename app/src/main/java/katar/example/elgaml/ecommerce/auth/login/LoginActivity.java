package katar.example.elgaml.ecommerce.auth.login;
...
import katar.example.elgaml.ecommerce.auth.forgetpass.ForgetPassword;
import katar.example.elgaml.ecommerce.auth.signup.SignUpActivity;
import katar.example.elgaml.ecommerce.model.User;
import com.google.gson.Gson;

import katar.example.elgaml.ecommerce.utils.ProjectUtils;
import katar.example.elgaml.ecommerce.utils.Validation;
            ...
            public void onClick(View view) {
                ...
                if (ProjectUtils.isNetworkAvailable(getApplicationContext())) {
                    ...
                    if (!TextUtils.isEmpty(name) && !TextUtils.isEmpty(password)) {
                        if (Validation.isValidEmail(name) || name.contains("0")) {
